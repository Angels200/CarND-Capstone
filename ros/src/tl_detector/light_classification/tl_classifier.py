    ...
    def get_classification(self, image):
        ...
        if not ((box_area < 1000) or (confidence < 0.5)):
            ...
            if 1:
                ...
                circles = cv2.HoughCircles(blur, cv2.HOUGH_GRADIENT, 0.5, 40, param1=70, param2=20, minRadius=2,
                                           maxRadius=20)
                circles_yel = cv2.HoughCircles(blur_yel, cv2.HOUGH_GRADIENT, 0.5, 40, param1=70, param2=20, minRadius=2,
                                               maxRadius=20)
